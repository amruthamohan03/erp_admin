...
// Columns that read like ids — we hide them by default since they're not
// meaningful to a human reading a license page.
...
export default function LicenseDetailPage() {
  ...
  const load = React.useCallback(async () => {
    ...
    try {
      ...
      if (!res.ok || !json.ok) {
        setError(json.error?.message ?? 'Failed to load license');
        setData(null);
        return;
      }
      setData(json.data);

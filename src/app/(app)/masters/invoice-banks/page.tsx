  ...
  return (
    <>
      ...
      <DataTable<Row>
        ...
        { key: 'invoice_bank_account_number', header: 'Account Number', sortable: true, className: 'font-mono text-xs' },
        { key: 'invoice_bank_swift', header: 'SWIFT', className: 'font-mono text-xs', render: (r: Row) => (
            <>

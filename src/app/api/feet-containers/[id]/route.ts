...
import { feetContainerMaster, type FeetContainerMasterInsert } from '@/db/schema';
...
export async function PUT(req: NextRequest, { params }: Ctx) {
  ...
  try {
    ...
    if (d.feet_container_size !== undefined) patch.feetContainerSize = d.feet_container_size;
    ...
    console.error('[feet-containers.PUT]', err);

...
import { provinceMaster, originMaster, type ProvinceMasterInsert } from '@/db/schema';
...
export async function PUT(req: NextRequest, { params }: Ctx) {
  ...
  try {
    ...
    if (d.province_name !== undefined) patch.provinceName = d.province_name;
    if (d.origin_id !== undefined) patch.originId = d.origin_id;
    ...
    console.error('[provinces.PUT]', err);

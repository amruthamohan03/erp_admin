...
import { getStageRecords } from '@/db/queries/imkpi';

// GET /api/v1/imkpi/stage-records?stage=&status_filter=&<filters>
// Drill-down: per-record working-days + On Time/Delayed status for one stage.

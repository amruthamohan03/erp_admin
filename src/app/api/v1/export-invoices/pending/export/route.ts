// GET /api/v1/export-invoices/pending/export — the pending list as .xlsx
...
export const GET = withErrorHandler(async () => {
  ...
  const res = xlsxResponse(await buildPendingInvoiceXlsx('export'), `Export_Pending_Invoicing_${dateStamp()}.xlsx`);

...
const MENU_URL = '/masters/done-by';
const MENU_NAME = 'Done By';
...
export async function seedDoneByMenu(
  ...
  if (existing) {
    ...
    if (!inserted) throw new Error('seedDoneByMenu: insert returned no row');
    menuId = inserted.id;
  }

...
const MENU_URL = '/masters/regimes';
const MENU_NAME = 'Customs Regimes';
...
export async function seedRegimesMenu(
  ...
  if (existing) {
    ...
    if (!inserted) throw new Error('seedRegimesMenu: insert returned no row');
    menuId = inserted.id;
  }

...
const MENU_URL = '/clients/dashboard';
const MENU_NAME = 'Clients Dashboard';
...
export async function seedClientsDashboardMenu(
  ...
  if (existing) {
    ...
    if (!inserted)
      throw new Error('seedClientsDashboardMenu: insert returned no row');
    menuId = inserted.id;
  }

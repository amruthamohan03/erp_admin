...
const MENU_URL = '/masters/origins';
const MENU_NAME = 'Origins';
...
export async function seedOriginsMenu(
  ...
  if (existing) {
    ...
    if (!inserted) throw new Error('seedOriginsMenu: insert returned no row');
    menuId = inserted.id;
  }

...
const MENU_URL = '/masters/clearances';
const MENU_NAME = 'Clearance Types';
...
export async function seedClearancesMenu(
  ...
  if (existing) {
    ...
    if (!inserted) throw new Error('seedClearancesMenu: insert returned no row');
    menuId = inserted.id;
  }

...
const MENU_URL = '/masters/expense-types';
const MENU_NAME = 'Expense Types';
...
export async function seedExpenseTypesMenu(
  ...
  if (existing) {
    ...
    if (!inserted)
      throw new Error('seedExpenseTypesMenu: insert returned no row');
    menuId = inserted.id;
  }

...
const MENU_URL = '/masters/kinds';
const MENU_NAME = 'Quotation Kinds';
...
export async function seedKindsMenu(
  ...
  if (existing) {
    ...
    if (!inserted) throw new Error('seedKindsMenu: insert returned no row');
    menuId = inserted.id;
  }

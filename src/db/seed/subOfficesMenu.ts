...
const MENU_URL = '/masters/sub-offices';
const MENU_NAME = 'Sub-Offices';
...
export async function seedSubOfficesMenu(
  ...
  if (existing) {
    ...
    if (!inserted) throw new Error('seedSubOfficesMenu: insert returned no row');
    menuId = inserted.id;
  }

...
const MENU_URL = '/masters/payment-types';
const MENU_NAME = 'Payment Types';
...
export async function seedPaymentTypesMenu(
  ...
  if (existing) {
    ...
    if (!inserted)
      throw new Error('seedPaymentTypesMenu: insert returned no row');
    menuId = inserted.id;
  }

...
const MENU_URL = '/masters/currencies';
const MENU_NAME = 'Currencies';
...
export async function seedCurrenciesMenu(
  ...
  if (existing) {
    ...
    if (!inserted) throw new Error('seedCurrenciesMenu: insert returned no row');
    menuId = inserted.id;
  }

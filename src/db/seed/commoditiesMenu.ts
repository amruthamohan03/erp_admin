...
const MENU_URL = '/masters/commodities';
const MENU_NAME = 'Commodities';
...
export async function seedCommoditiesMenu(
  ...
  if (existing) {
    ...
    if (!inserted) throw new Error('seedCommoditiesMenu: insert returned no row');
    menuId = inserted.id;
  }

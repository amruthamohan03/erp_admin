...
const MENU_URL = '/masters/goods-types';
const MENU_NAME = 'Goods Types';
...
export async function seedGoodsTypesMenu(
  ...
  if (existing) {
    ...
    if (!inserted) throw new Error('seedGoodsTypesMenu: insert returned no row');
    menuId = inserted.id;
  }

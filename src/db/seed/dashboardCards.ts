...
const CARDS: Card[] = [
  ...
  // The 13 status tiles on /imports. card_content_id matches the key
  // /api/v1/imports/stats returns for that filter (built from the shared
  // importFilterPredicates), so a tile and the grid can never disagree.
  {
    cardKey: 'import_completed',
    cardContentId: 'completed',
    cardTitle: 'Completed',
    cardIcon: 'CheckCircle2',
    cardColor: 'emerald',
    cardUrl: '/imports',
    cardOrder: 2,
    cardCategory: 'import_dashboard',
    dataSource: '/api/v1/imports/stats#completed',
    display: 'Y',
  },
  {
    cardKey: 'import_in_progress',
    cardContentId: 'in_progress',
    ...
    cardOrder: 3,
    cardCategory: 'import_dashboard',
    dataSource: '/api/v1/imports/stats#in_progress',
    display: 'Y',
  },
  {
    cardKey: 'import_in_transit',
    cardContentId: 'in_transit',
    ...
    cardOrder: 4,
    cardCategory: 'import_dashboard',
    dataSource: '/api/v1/imports/stats#in_transit',
    display: 'Y',
  },
  {
    cardKey: 'import_crf_missing',
    cardContentId: 'crf_missing',
    cardTitle: 'CRF Missing',
    cardIcon: 'FileX',
    cardColor: 'rose',
    cardUrl: '/imports',
    cardOrder: 5,
    cardCategory: 'import_dashboard',
    dataSource: '/api/v1/imports/stats#crf_missing',
    display: 'Y',
  },
  {
    cardKey: 'import_ad_missing',
    cardContentId: 'ad_missing',
    cardTitle: 'AD Missing',
    cardIcon: 'CalendarX',
    cardColor: 'amber',
    cardUrl: '/imports',
    cardOrder: 6,
    cardCategory: 'import_dashboard',
    dataSource: '/api/v1/imports/stats#ad_missing',
    display: 'Y',
  },
  {
    cardKey: 'import_insurance_missing',
    cardContentId: 'insurance_missing',
    cardTitle: 'Insurance Missing',
    cardIcon: 'ShieldAlert',
    cardColor: 'orange',
    cardUrl: '/imports',
    cardOrder: 7,
    cardCategory: 'import_dashboard',
    dataSource: '/api/v1/imports/stats#insurance_missing',
    display: 'Y',
  },
  {
    cardKey: 'import_audited_pending',
    cardContentId: 'audited_pending',
    cardTitle: 'Audited Pending',
    cardIcon: 'ClipboardCheck',
    cardColor: 'violet',
    cardUrl: '/imports',
    cardOrder: 8,
    cardCategory: 'import_dashboard',
    dataSource: '/api/v1/imports/stats#audited_pending',
    display: 'Y',
  },
  {
    cardKey: 'import_archived_pending',
    cardContentId: 'archived_pending',
    cardTitle: 'Archived Pending',
    cardIcon: 'Archive',
    cardColor: 'slate',
    cardUrl: '/imports',
    cardOrder: 9,
    cardCategory: 'import_dashboard',
    dataSource: '/api/v1/imports/stats#archived_pending',
    display: 'Y',
  },
  {
    cardKey: 'import_dgda_in_pending',
    cardContentId: 'dgda_in_pending',
    cardTitle: 'DGDA In Pending',
    cardIcon: 'LogIn',
    cardColor: 'teal',
    cardUrl: '/imports',
    cardOrder: 10,
    cardCategory: 'import_dashboard',
    dataSource: '/api/v1/imports/stats#dgda_in_pending',
    display: 'Y',
  },
  {
    cardKey: 'import_liquidation_pending',
    cardContentId: 'liquidation_pending',
    cardTitle: 'Liquidation Pending',
    cardIcon: 'Wallet',
    cardColor: 'fuchsia',
    cardUrl: '/imports',
    cardOrder: 11,
    cardCategory: 'import_dashboard',
    dataSource: '/api/v1/imports/stats#liquidation_pending',
    display: 'Y',
  },
  {
    cardKey: 'import_quittance_pending',
    cardContentId: 'quittance_pending',
    cardTitle: 'Quittance Pending',
    cardIcon: 'Receipt',
    cardColor: 'yellow',
    cardUrl: '/imports',
    cardOrder: 12,
    cardCategory: 'import_dashboard',
    dataSource: '/api/v1/imports/stats#quittance_pending',
    display: 'Y',
  },
  {
    cardKey: 'import_dgda_out_pending',
    cardContentId: 'dgda_out_pending',
    cardTitle: 'DGDA Out Pending',
    cardIcon: 'LogOut',
    cardColor: 'red',
    cardUrl: '/imports',
    cardOrder: 13,
    cardCategory: 'import_dashboard',
    dataSource: '/api/v1/imports/stats#dgda_out_pending',
    display: 'Y',
  },
  {
    cardKey: 'import_dispatch_deliver_pending',
    cardContentId: 'dispatch_deliver_pending',
    cardTitle: 'BS Pending',
    cardIcon: 'Send',
    cardColor: 'lime',
    cardUrl: '/imports',
    cardOrder: 14,
    cardCategory: 'import_dashboard',
    dataSource: '/api/v1/imports/stats#dispatch_deliver_pending',
    display: 'Y',
  },
  ...
  {
    cardKey: 'license.expired',
    cardContentId: 'expired',
    cardTitle: 'Expired',
    cardSubtitle: 'Past expiry date',
    cardIcon: 'CalendarX',
    // Red: a lapsed licence blocks work, which is what this app's red means.
    cardColor: 'rose',
    cardUrl: '/licenses',
    cardOrder: 2,
    cardCategory: 'license_dashboard',
    // EXPIRED is derived from the expiry date, never stored — see
    // src/db/queries/licenseFilters.ts.
    dataSource: '/api/v1/licenses/stats#expired_count',
    display: 'Y',
  },
  {

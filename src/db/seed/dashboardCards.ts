...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    cardOrder: 2,
    cardCategory: 'license_dashboard',
    dataSource: '/api/v1/licenses/stats#active_count',
    display: 'Y',
  },
  {
  ...
  {
    cardKey: 'license.closed',
    cardContentId: 'closed',
    cardTitle: 'Closed',
    cardSubtitle: 'Rejected / Expired',
    cardIcon: 'XCircle',
    cardColor: 'slate',
    cardUrl: '/licenses',
    cardOrder: 5,
    cardCategory: 'license_dashboard',
    dataSource: '/api/v1/licenses/stats#closed_count',
    display: 'Y',
  },
  {

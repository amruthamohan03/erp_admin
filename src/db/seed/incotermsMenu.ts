...
const MENU_URL = '/masters/incoterms';
const MENU_NAME = 'Incoterms';
...
export async function seedIncotermsMenu(
  ...
  if (existing) {
    ...
    if (!inserted)
      throw new Error('seedIncotermsMenu: insert returned no row');
    menuId = inserted.id;
  }

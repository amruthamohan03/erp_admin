...
const MENU_URL = '/masters/provinces';
const MENU_NAME = 'Provinces';
...
export async function seedProvincesMenu(
  ...
  if (existing) {
    ...
    if (!inserted)
      throw new Error('seedProvincesMenu: insert returned no row');
    menuId = inserted.id;
  }

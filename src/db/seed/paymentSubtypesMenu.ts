...
const MENU_URL = '/masters/payment-subtypes';
const MENU_NAME = 'Payment Subtypes';
...
export async function seedPaymentSubtypesMenu(
  ...
  if (existing) {
    ...
    if (!inserted)
      throw new Error('seedPaymentSubtypesMenu: insert returned no row');
    menuId = inserted.id;
  }

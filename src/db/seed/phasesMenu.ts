...
const MENU_URL = '/masters/phases';
const MENU_NAME = 'Phases';
...
export async function seedPhasesMenu(
  ...
  if (existing) {
    ...
    if (!inserted) throw new Error('seedPhasesMenu: insert returned no row');
    menuId = inserted.id;
  }

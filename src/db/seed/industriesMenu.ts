...
const MENU_URL = '/masters/industries';
const MENU_NAME = 'Industries';
...
export async function seedIndustriesMenu(
  ...
  if (existing) {
    ...
    if (!inserted)
      throw new Error('seedIndustriesMenu: insert returned no row');
    menuId = inserted.id;
  }

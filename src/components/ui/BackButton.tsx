...
/**
 * Drop one of these at the top of any page that isn't the dashboard / login.
 * Uses browser history when possible (so the user lands exactly where they
 * came from) and falls back to a safe URL for direct-entry cases (typed URL,
 * opened in new tab, etc.).
 *
